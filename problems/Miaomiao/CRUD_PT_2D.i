...
#
  [./bc_func]
    type = ParsedFunction
    value = {system_pressure_Pa}*{scaling_factor}+alpha*({crud_thickness_microns}*{scaling_factor}*{crud_thickness_microns}*{scaling_factor}-y*y)
# y is in mm
    vars = 'alpha'
    vals = 4*{WaterViscosityInChimney}*V_exit/({crud_thickness_microns}*{scaling_factor}*{chimney_radius_microns}*{scaling_factor}*{chimney_radius_microns}*{scaling_factor})
  [../]
#
