[Mesh]
  ...
  file = Real_CRUD_Extruded/CRUD-Hole_remeshed_with_sideset.e
  #type = GeneratedMesh
  #dim = 2
...
[MeshModifiers]
  [./extrude]
    type = MeshExtruder
    num_layers = 10
    extrusion_vector = '0 0 20e-3'	# 70 microns is pretty large...use 20 instead
  #  height = 7e-2
  #  extrusion_axis = 2 # Z
    bottom_sideset = '2'
    top_sideset = '3'
...
# pressure
  ...
  [./chimney_crud_pressure]
    ...
    variable = crud_pressure
    #boundary = 'left'
    boundary = 5 	# not sure if this is the right boundary...
