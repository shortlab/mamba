...
[AuxVariables]
  [./from_Liquid_vapor_height_app]
    order = FIRST
    family = SCALAR
  [../]

  [./from_Liquid_pressure_app]
    order = FIRST
    family = SCALAR
  [../]
...
[Functions]
  active = 'toppressure chimneypressure'
#  [./toppressure]
#    type = ParsedFunction
#    value = alpha+50
#    vars = 'alpha'
...
[Postprocessors]
  [./from_Liquid_vapor_height]
    type = ScalarVariable
    variable=from_Liquid_vapor_height_app
  [../]

  [./from_Liquid_pressure]
    type = ScalarVariable
    variable=from_Liquid_pressure_app
  [../]
