...
[MultiApps]
  [./vapor]
    ...
    app_type = MambaApp
    positions = '0 0.0 0'
    input_files = /home/mmjin/projects/mamba-dev/problems/Miaomiao/MultiApp/PPTransfer/subsub_5th.i
    execute_on = timestep
    #sub_cycling = true
...
[Transfers]
  ...
  [./pp_heat_cond_from_vapor]
    type = MultiAppPostprocessorTransfer
    direction = from_multiapp
    execute_on = timestep
    multi_app = vapor
    from_postprocessor = AvgHeatCond
    to_postprocessor = AvgHeatCond
    #fixed_meshes = true
  [../]
