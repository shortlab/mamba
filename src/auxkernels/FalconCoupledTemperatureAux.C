...
#include "FalconCoupledTemperatureAux.h"
...
FalconCoupledTemperatureAux::FalconCoupledTemperatureAux(const std::string & name,
...
Real
FalconCoupledTemperatureAux::computeValue()
{
