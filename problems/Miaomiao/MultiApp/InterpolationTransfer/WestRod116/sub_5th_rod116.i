#all liquid region for Rod 116, use MultiApp to transfer information with subsub_5th.i
#[GlobalParams]
...
[Variables]
  ...
  [./Li+]
    order =  FIRST
    family =  LAGRANGE
    initial_condition = 3.1429e-4 # mol/kg 2.2ppm
   [../]

  [./OH-]
    order =  FIRST
    family =  LAGRANGE
    initial_condition = 4.4324e-05 #mol/kg 
  [../]

  [./H+]
    order =  FIRST
    family =  LAGRANGE
    initial_condition = 1.5727e-07 #pH=7, k_ion=-11.55
  [../]

  [./H3BO3]
    order =  FIRST
    family =  LAGRANGE
    initial_condition = 0.0926 #1000ppm
   [../]
...
#temperature
  ...
  [./temperature_up]
    ...
    boundary = 2
    T_coolant = 602.594
    h_convection_coolant = 1.4350e4 #45000.0
  [../]
...
# H+
  [./H+_up]
    ...
    variable =  H+
    boundary =  2
    value =  1.5727e-07   #mol/kg pH=7(1e-7 mol/L)
  [../]
...
# Li+
  [./Li+_up]
    ...
    variable =  Li+
    boundary =  2
    value =  3.1429e-04 #mol/kg also 2.2ppm
  [../]
...
# H3BO3
  [./H3BO3_up]
    ...
    variable =  H3BO3
    boundary =  2
    value =  0.0926   #mol/kg, also 1000ppm
  [../]
...
# OH-
  [./OH-_up]
    ...
    variable =  OH-
    boundary =  2
    value =  4.4324e-5 #mol/kg density=kg/m^3 water ion product is about -11.6
  [../]
...
# Give the material properties in SI, then apply whatever scaling factor you want.
    ...
    cell_inner_radius = 4.0e-6
    cell_outer_radius = 2.3631e-05
    CladHeatFluxIn = 1000000.0
    ConvectionCoefficient = 1.4350e4
...
[MultiApps]
  [./vapor]
    ...
    app_type = MambaApp
    positions = '0 0.0 0'
    input_files = /home/mmjin/projects/mamba-dev/problems/Miaomiao/MultiApp/InterpolationTransfer/WestRod116/subsub_5th_rod116.i
    execute_on = timestep
    #sub_cycling = true
...
[Transfers]
  ...
  [./pp_sat_pressure_from_liquid]
    type = MultiAppPostprocessorTransfer
    direction = to_multiapp
    execute_on = timestep
    multi_app = vapor
    from_postprocessor = Avg_Psat_interface
    to_postprocessor = Avg_Psat_interface
  [../]

  [./pp_capi_pressure_from_liquid]
    type = MultiAppPostprocessorTransfer
    direction = to_multiapp
    execute_on = timestep
    multi_app = vapor
    from_postprocessor = Avg_Pc_interface
    to_postprocessor = Avg_Pc_interface
  [../]
