...
[Mesh]
  type = FileMesh
  file = mesh/solid_surface.e
[]

[MeshModifiers]
  [./extrude]
    type = MeshExtruder
    num_layers = {crud_thickness_microns}
    extrusion_vector = '0 0 {crud_thickness_microns * 1e-3}'
  #  height = {crud_thickness_microns * 1e-3}
  #  extrusion_axis = 2 # Z
    bottom_sideset = '2'
    top_sideset = '3'
  [../]
...
#  output_initial = true
  file_base = out-Microstructure-Fine
  interval = 1
#  xda = true
  exodus = true
  perf_log = true
