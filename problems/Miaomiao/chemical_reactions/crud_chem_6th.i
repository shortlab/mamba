...
#This is the master file, changing from crud_chem_5th.i, now with steady state. no precipitation chemical reaction
[Mesh]
  type = GeneratedMesh
  dim = 2
...
[Functions]
  active = 'functionpressure '
  [./functionpressure]
    type = ParsedFunction
    value = '15616.62527+50*(0.025-y)'
  [../]
[]
