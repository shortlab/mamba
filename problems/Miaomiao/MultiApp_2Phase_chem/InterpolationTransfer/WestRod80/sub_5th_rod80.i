...
[Variables]
  ...
  [./OH-]
    order =  FIRST
    family =  LAGRANGE
    initial_condition = 4.4346e-05 #mol/kg 
  [../]

  [./H+]
    order =  FIRST
    family =  LAGRANGE
    initial_condition = 1.5734e-07 #pH=7, k_ion=-11.55
  [../]
...
#temperature
  ...
  [./temperature_up]
    ...
    boundary = 2
    T_coolant = 608.15
    h_convection_coolant = 2.1589e4 #45000.0
  [../]
...
# H+
  [./H+_up]
    ...
    variable =  H+
    boundary =  2
    value =  1.5734e-07   #mol/kg pH=7(1e-7 mol/L)
  [../]
...
# OH-
  [./OH-_up]
    ...
    variable =  OH-
    boundary =  2
    value =  4.4346e-5 #mol/kg density=661kg/m^3 water ion product is about -11.6
  [../]
...
# Give the material properties in SI, then apply whatever scaling factor you want.
    ...
    ConvectionCoefficient = 2.1589e4
...
[MultiApps]
  [./vapor]
    ...
    app_type = MambaApp
    positions = '0 0.0 0'
    input_files = /home/mmjin/projects/mamba-dev/problems/Miaomiao/MultiApp/InterpolationTransfer/WestRod80/subsub_5th_rod80.i
    execute_on = timestep
    #sub_cycling = true
