#all liquid region for Rod 90, use MultiApp to transfer information with subsub_5th.i
#[GlobalParams]
...
#temperature
  ...
  [./temperature_up]
    ...
    boundary = 2
    T_coolant = 602.594
    h_convection_coolant = 1.4228e4 #45000.0
  [../]
...
# Give the material properties in SI, then apply whatever scaling factor you want.
    ...
    cell_inner_radius = 2.5e-6
    cell_outer_radius = 1.8209e-05
    CladHeatFluxIn = 1000000.0
    ConvectionCoefficient = 1.4228e4
...
[MultiApps]
  [./vapor]
    ...
    app_type = MambaApp
    positions = '0 0.0 0'
    input_files = /home/mmjin/projects/mamba-dev/problems/Miaomiao/MultiApp/InterpolationTransfer/WestRod90/subsub_5th_rod90.i
    execute_on = timestep
    #sub_cycling = true
