...
[AuxVariables]
  active =  'disp_x             disp_y             thickness_change 
             ...
             nodal_tortuosity   ECofLiBO2          nodal_Tsat_h2o mass_flux VaporTemp  CapillaryPressure  HeatCond  tryingheatcond  interface_vapor_pressure'

  [./interface_vapor_pressure]
    order = CONSTANT
    family = MONOMIAL
  [../]
...
[AuxKernels]
  ...
  [./interface_vapor_pressure]
    type = InterfaceVaporPressureAux
    variable = interface_vapor_pressure
    CapillaryPressure = CapillaryPressure
    LiquidPressure = crud_pressure
  [../]
