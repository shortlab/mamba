...
#temperature
  ...
  [./temperature_up]
    ...
    boundary = 2
    T_coolant = 608.15
    h_convection_coolant = 1.4946e4 #45000.0
  [../]
...
# Give the material properties in SI, then apply whatever scaling factor you want.
    ...
    cell_outer_radius = 1.4105e-05
    CladHeatFluxIn = 1000000.0
    ConvectionCoefficient = 1.4946e4
...
[MultiApps]
  [./vapor]
    ...
    app_type = MambaApp
    positions = '0 0.0 0'
    input_files = /home/mmjin/projects/mamba-dev/problems/Miaomiao/MultiApp/InterpolationTransfer/WestRod88/subsub_5th_rod88.i
    execute_on = timestep
    #sub_cycling = true
