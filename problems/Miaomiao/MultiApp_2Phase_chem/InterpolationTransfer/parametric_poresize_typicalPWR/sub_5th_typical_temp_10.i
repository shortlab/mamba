...
pore_size_avg_baseline = .00000052500000000000
pore_size_max_baseline = 0.0000008
...
[MultiApps]
  [./vapor]
    ...
    app_type = MambaApp
    positions = '0 0.0 0'
input_files = /home/mmjin/projects/mamba-dev/problems/Miaomiao/MultiApp/InterpolationTransfer/parametric_poresize_typicalPWR/subsub_5th_typical_temp_10.i
    execute_on = timestep
    #sub_cycling = true
...
[Transfers]
  ...
  [./pp_sat_temp_from_liquid]
    ...
    #fixed_meshes = true
  [../]
  [./capillary_pressure_from_liquid]
    type = MultiAppPostprocessorTransfer
    direction = to_multiapp
    execute_on = timestep
    multi_app = vapor
    from_postprocessor = CapillaryPressure
    to_postprocessor = CapillaryPressure
    #fixed_meshes = true
  [../]
  [./pp_transfer]
    type = MultiAppPostprocessorTransfer
