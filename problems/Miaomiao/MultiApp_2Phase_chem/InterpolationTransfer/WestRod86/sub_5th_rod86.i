...
#temperature
  ...
  [./temperature_up]
    ...
    boundary = 2
    T_coolant = 608.15
    h_convection_coolant = 1.4855e4 #45000.0
  [../]
...
# OH-
  [./OH-_up]
    ...
    variable =  OH-
    boundary =  2
    value =  4.4324e-5 #mol/kg density=661kg/m^3 water ion product is about -11.6
  [../]
...
# Give the material properties in SI, then apply whatever scaling factor you want.
    ...
    cell_outer_radius = 9.821280021861477e-06
    CladHeatFluxIn = 1000000.0
    ConvectionCoefficient = 1.4855e4
...
[MultiApps]
  [./vapor]
    ...
    app_type = MambaApp
    positions = '0 0.0 0'
    input_files = /home/mmjin/projects/mamba-dev/problems/Miaomiao/MultiApp/InterpolationTransfer/WestRod86/subsub_5th.i
    execute_on = timestep
    #sub_cycling = true
